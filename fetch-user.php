...
/*   echo "user last activity: " . $user_last_activity;
  ...
  if ($user_last_activity > $current_timestamp) {
    $status = '  <button class="btn btn-outline-success form-control">
    Online
  </button>';
  } else {
  ...
  $output .= '
    ...
    <tr>
      ...
      <td> '. $status .' </td>
      <td>
        <button type="button" class="btn btn-primary start_chat" data-touserid="' . $row['user_id'] . '"
        data-tousername="' . $row['username'] . '">
            Start Chat
        </button>
      </td>
    </tr>
